...
void main()
{
    INPUT input[NUM_VALUES]= {0,0,0,0,0}, newSet; //input is the set that will saved each time and newSet is the set that the user enters
    // input[NUM_VALUES] is set to 0 everywhere because we do not want the program to give junk values if each set contains nothing
    char choice, save;
    int set, slot, answer, ix;
